...
namespace NetworkingMidtermServer
{
    class Program
    {
        ...
        public static void ReceiveData(byte[] thebuffer, int clientnum)
        {

            int rec = server.ReceiveFrom(thebuffer, ref remoteClient);
